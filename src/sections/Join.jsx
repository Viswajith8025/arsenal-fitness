        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-center">
          ...
          <div className="space-y-8 text-left">
            <div className="space-y-4">
              ...
              <h2 className="text-5xl md:text-7xl lg:text-8xl font-black uppercase tracking-tight text-white leading-none">
                START YOUR <br />
                ...
                >
                  <div className="space-y-6">
                    <div className="space-y-3">
                      <label className="text-[9px] font-bold uppercase tracking-[0.4em] text-gray-500 block ml-1 opacity-70">Full Name</label>
                      <input
                        type="text"
                        required
                        ...
                        className="w-full bg-[#0a0a0a] border border-white/10 rounded-xl px-7 py-5 text-[13px] font-bold text-white outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/20 transition-all placeholder:text-gray-800 uppercase"
                      />
                    </div>

                    <div className="space-y-3">
                      <label className="text-[9px] font-bold uppercase tracking-[0.4em] text-gray-500 block ml-1 opacity-70">Primary Link (Phone)</label>
                      <input
                        type="tel"
                        required
                        ...
                        className="w-full bg-[#0a0a0a] border border-white/10 rounded-xl px-7 py-5 text-[13px] font-bold text-white outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/20 transition-all placeholder:text-gray-800"
                      />
                    </div>

                    <div className="space-y-3">
                      <label className="text-[9px] font-bold uppercase tracking-[0.4em] text-gray-500 block ml-1 opacity-70">Training Goal</label>
                      <div className="relative">
                        <select
                          value={formData.goal}
                          onChange={(e) => setFormData({ ...formData, goal: e.target.value })}
                          className="w-full bg-[#0a0a0a] border border-white/10 rounded-xl px-7 py-5 text-[13px] font-bold text-white outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/20 transition-all appearance-none cursor-pointer uppercase"
                        >
                    ...
                    <div className="space-y-3">
                      <label className="text-[9px] font-bold uppercase tracking-[0.4em] text-gray-500 block ml-1 opacity-70">Select Your Slot</label>
                      <div className="relative">
                        <select
                          value={formData.slot}
                  ...
                  <button
                    type="submit"
                    className="group relative w-full bg-blue-600 hover:bg-blue-700 text-white font-bold uppercase tracking-[0.4em] py-6 text-[11px] rounded-xl transition-all shadow-xl shadow-blue-600/20 flex items-center justify-center gap-4 active:scale-[0.98]"
                  >
                    JOIN NOW
