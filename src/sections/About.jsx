    ...
    <section id="about" className="bg-black min-h-screen flex flex-col md:flex-row items-stretch">
      ...
      <div className="md:w-1/2 flex flex-col justify-center px-8 md:px-16 py-20 md:py-32 space-y-10 bg-black">
        <div className="space-y-2">
          <span className="text-blue-500 text-[10px] font-black uppercase tracking-[0.6em]">Our Philosophy</span>
        ...
        <div>
          <a href="#training-zones" className="text-[11px] font-black uppercase tracking-[0.3em] text-blue-500 flex items-center gap-3 hover:gap-5 transition-all">
