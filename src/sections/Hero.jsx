    ...
    <section id="home" className="relative h-screen flex flex-col items-center justify-center bg-black overflow-hidden select-none">
      ...
      <div className="relative z-10 text-center px-6 pt-20 flex flex-col items-center">
        ...
        >
          <div className="mb-12 space-y-4">
            <p className="text-gray-500 text-[12px] md:text-base font-serif font-black uppercase tracking-tighter">
              ARSENAL FITNESS MALAPARAMBA
            </p>
            <div className="w-16 h-px bg-blue-600/30 mx-auto rounded-full" />
          </div>

          <h1 className="text-[4.5rem] md:text-[13rem] font-serif font-black uppercase text-white leading-[0.8] mb-2 tracking-tighter">
            BUILT
          </h1>
          <h1 className="text-[4.5rem] md:text-[13rem] font-serif font-black uppercase tracking-tighter text-blue-500 leading-[0.8] drop-shadow-[0_0_40px_rgba(59,130,246,0.6)]">
            DIFFERENT
          </h1>
        </motion.div>
      </div>
      ...
      <div className="absolute bottom-16 left-0 right-0 z-20 flex justify-center px-6">
        <div className="flex flex-col sm:flex-row gap-4 w-full max-w-xl">
          <a
            href="#join"
            className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-serif font-black uppercase tracking-tighter py-5 text-[14px] rounded-xl transition-all shadow-2xl shadow-blue-600/20 text-center"
          >
            JOIN NOW
          </a>
          <a
